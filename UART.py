...
class Work(QtWidgets.QMainWindow):
    ...
    def menus(self):
        ...
        br_96=QtWidgets.QAction("9600",self)
        br_14 = QtWidgets.QAction("14400", self)
        br_19 = QtWidgets.QAction("19200", self)
        br_28 = QtWidgets.QAction("28800", self)
        br_38 = QtWidgets.QAction("38400", self)
        br_57 = QtWidgets.QAction("57600", self)
        br_115 = QtWidgets.QAction("115200", self)
        br_230 = QtWidgets.QAction("230400", self)
    ...
    def response_boud(self,action_bound):
        ...
        self.serial_boud=action_bound.text()
